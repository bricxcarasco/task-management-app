export default {
  labelIdle:
    '画像又はビデオをドラッグ&ドロップ又は <span class="filepond--label-action">ファイル選択</span>',
  ...
  imageValidateSizeLabelExpectedMinSize:
    '画像の最小サイズは{minWidth}×{minHeight}です',
  imageValidateSizeLabelExpectedMaxSize:
    '画像の最大サイズは{maxWidth} × {maxHeight}です',
