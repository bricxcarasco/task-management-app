            ...
            <div class="row">
              ...
              <div class="col-12">
                ...
                <div class="mb-3">
                  ...
                  <input
                    class="form-control"
                    :class="errors?.url != null ? 'is-invalid' : ''"
                    name="url"
                    type="text"
                  ...
                  <div
                    v-show="errors?.url"
                    v-for="(error, index) in errors?.url"
                    :key="index"
                    class="invalid-feedback"
                  >
                    {{ error }}
  ...
  setup(props, { emit }) {
    ...
    const updateModalTitle = () => {
      modalTitle.value = isEdit()
        ? i18n.global.t('headers.url_edit')
        : i18n.global.t('headers.url_registration');
    };
    ...
    const submitForm = (event) => {
      ...
      const apiCall = isEdit()
        ? neoProfileApiService.updateUrl(formData.value.id, formData.value)
        : neoProfileApiService.addUrl(neo.value.id, formData.value);
