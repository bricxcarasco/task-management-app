  ...
  >
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="" @submit="submitDeleteUrl" novalidate>
...
export default {
  ...
  setup(props, { emit }) {
     ...
     */
    const resetModal = () => {
      const modal = document.querySelector('#delete-url-modal');
     ...
     * @returns {void}
     */
    const submitDeleteUrl = async (event) => {
