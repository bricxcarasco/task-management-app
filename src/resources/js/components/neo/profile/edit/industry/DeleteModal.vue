  ...
  >
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="" @submit="submitDeleteIndustry" novalidate>
...
export default {
  ...
  setup(props, { emit }) {
     ...
     */
    const resetModal = () => {
      const modal = document.querySelector('#delete-industry-modal');
     ...
     * @returns {void}
     */
    const submitDeleteIndustry = async (event) => {
