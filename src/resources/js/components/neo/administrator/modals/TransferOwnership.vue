      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">
            {{ $t('links.transfer_of_owner_authority') }}
          </h4>
          <button
            class="btn-close"
            type="button"
        ...
        <div class="modal-body text-center">
          ...
          <p class="mt-4 mb-0">
            {{ $t('messages.neo.transfer_ownership_prompt') }}
          </p>
          <button
            ...
            @click="handleClick"
          >
            {{ $t('buttons.neo_transfer_ownership') }}
          </button>
          <p class="mt-4">
            {{ $t('messages.neo.transfer_ownership_message') }}
          </p>
        </div>
      </div>
    </div>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    /**
     * Trigger transfer ownership button and emit to parent component
     *
     * @returns {void}
     */
    const handleClick = () => {
      const data = {
        ...
        type: NeoBelongRoleType.OWNER,
      };
      setLoading(true);
      emit('transferOwnership', data);
    };
