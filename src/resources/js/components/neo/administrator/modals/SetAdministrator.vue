      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">
            {{ $t('links.designated_as_an_administrator') }}
          </h4>
          <button
            class="btn-close"
            type="button"
        ...
        <div class="modal-body text-center">
          ...
          <p class="mt-4 mb-0">
            {{ $t('messages.neo.set_administrator_prompt') }}
          </p>
          <button
  ...
  setup(props, { emit }) {
    ...
    const handleClick = () => {
      const data = {
        ...
        type: NeoBelongRoleType.ADMINISTRATOR,
      };
      setLoading(true);
      emit('setAdministrator', data);
    };
