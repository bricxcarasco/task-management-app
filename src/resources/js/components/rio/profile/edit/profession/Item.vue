...
export default {
  ...
  setup(props) {
    /* eslint no-undef: 0 */
    const deleteModalNode = document.getElementById('delete-profession-modal');
    const formModalNode = document.getElementById('profession-form-modal');
    ...
    const onEdit = () => {
      ...
      Common.fillForm(form, props.profession);
