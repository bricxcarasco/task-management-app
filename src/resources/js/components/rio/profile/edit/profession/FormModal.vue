          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-12">
                ...
                <label class="form-label" for="registratin-profession-field">
                  {{ $t('labels.profession') }}
  ...
  setup(props, { emit }) {
    ...
    const updateModalTitle = () => {
      modalTitle.value = isEdit()
        ? i18n.global.t('headers.profession_edit')
        : i18n.global.t('headers.profession_registration');
    };
    ...
    const submitForm = async (event) => {
      ...
      const apiCall = isEdit()
        ? rioProfileApiService.updateProfession(
            formData.value.id,
            formData.value
          )
        : rioProfileApiService.addProfession(formData.value);
