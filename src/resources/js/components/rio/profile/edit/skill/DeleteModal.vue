  ...
  >
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="" @submit="submitDeleteSkill" novalidate>
...
export default {
  ...
  setup(props, { emit }) {
     ...
     */
    const resetModal = () => {
      const modal = document.querySelector('#delete-skill-modal');
     ...
     * @returns {void}
     */
    const submitDeleteSkill = async (event) => {
