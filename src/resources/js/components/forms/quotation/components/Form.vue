      ...
      <div class="row">
        ...
        <div class="col-12 col-md-9 offset-md-3">
          <div class="pb-4 pb-md-0">
            <a class="btn btn-link" href="/forms/quotations">
                    ...
                    <td class="text-end">
                      <div class="flatpickr date-picker_ymd2 form-date-picker">
                        <input
                          ...
                          class="form--clear text-end c-primary flatpickr-input"
                          :class="
                            errors?.expiration_date != null ? 'is-invalid' : ''
                          "
                          data-input
              ...
              >
                ...
                <div class="flex-1 mx-auto text-center">
                  ...
                  >
                    <input
                      type="file"
                      class="js-form-quotation-file-uploader"
                      name="upload_file[]"
              ...
              <table class="table table-striped mb-0">
                <tbody>
                  <quotation-product-list
                    ...
                    :products="products"
                    @delete-quotation-product="handleDeleteProduct"
                    @duplicate-quotation-product="handleDuplicateProduct"
                  />
                  <tr>
                    <th></th>
                    <td class="text-end">
...
import QuotationProductModal from '../../modals/ProductModal.vue';
import QuotationProductList from '../product/ProductList.vue';
import FormTypes from '../../../../enums/FormTypes';

export default defineComponent({
  name: 'QuotationCreateForm',
  props: {
    rio: {
      type: [Array, Object],
      required: true,
  ...
  setup(props, { emit }) {
    ...
    const updateModel = () => {
      ...
      formData.value.type = FormTypes.QUOTATION;
    ...
    const loadExistingData = () => {
      if (!_.isEmpty(formData.value)) {
        // Issuer information
        issuer.value = {
          name: formData.value?.issuer_name ?? '',
          department_name: formData.value?.issuer_department_name ?? '',
          address: formData.value?.issuer_address ?? '',
          tel: formData.value?.issuer_tel ?? '',
          fax: formData.value?.issuer_fax ?? '',
          business_number: formData.value?.issuer_business_number ?? '',
        };
      }
    };
    ...
    const initializeFileuploader = () => {
      ...
      fileUploader.value = FileUploaderFacade({
        selector: '.js-form-quotation-file-uploader',
