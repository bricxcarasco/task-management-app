<template>
  <div class="preview">
    <h3 class="preview__header">{{ $t('preview.invoice') }}</h3>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" class="text-left">
                {{ $t('preview.invoice_no') }}：
              </td>
              <td colspan="4" class="text-left">
                {{ form_data.invoice_no ?? form_data.form_no }}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colspan="6" class="preview__table--bottom-line p-0 text-left">
                {{ form_data.subject ?? form_data.title }}
              </td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td
                colspan="1"
                class="
                  preview__table-remarks preview__table-payee
                  border-none
                  text-left
                  p-0
                "
              >
                【 {{ $t('preview.payee_information') }} 】
              </td>
            </tr>
            <tr class="preview__table--blank-row">
              <td colspan="6" class="border-none"></td>
...
export default defineComponent({
  name: 'PreviewContentInvoiceComponent',
  props: {
    form_data: {
      type: [Array, Object],
      required: true,
