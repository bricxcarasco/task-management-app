<template>
  <div class="preview">
    <h3 class="preview__header">{{ $t('preview.quotation') }}</h3>
        ...
        <table class="preview__table table preview__table--no-border">
          <tbody>
            ...
            <tr>
              ...
              >
                <span class="text-justify nowrap">{{
                  $t('preview.estimated_expiration_date')
                }}</span>
                <span class="float-right">：</span>
              </td>
              <td colspan="6" class="preview__table--bottom-line p-0 text-left">
    ...
    <div class="preview__section">
      <table class="preview__table preview__table--no-border table">
        <tbody>
          <tr v-if="form_data.remarks !== null">
            <td class="preview__table-paragraph">{{ form_data.remarks }}</td>
          </tr>
        </tbody>
      </table>
    </div>
...
export default defineComponent({
  name: 'PreviewContentQuotationComponent',
  props: {
    form_data: {
      type: [Array, Object],
      required: true,
