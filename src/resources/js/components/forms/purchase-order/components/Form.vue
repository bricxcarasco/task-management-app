                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-end">
                      ...
                      <button
                        v-if="
                          basicSetting?.payment_term_list &&
                          basicSetting?.payment_term_list?.length !== 0
                        "
                        class="btn btn-link fs-xs"
                        type="button"
              ...
              >
                ...
                <div class="flex-1 mx-auto text-center">
                  ...
                  >
                    <input
                      type="file"
                      class="js-form-purchase-order-file-uploader"
                      name="upload_file[]"
              ...
              <table class="table table-striped mb-0">
                <tbody>
                  <purchase-order-product-list
                    ...
                    :products="products"
                    @delete-purchase-order-product="handleDeleteProduct"
                    @duplicate-purchase-order-product="handleDuplicateProduct"
                  />
                  <tr>
                    <th></th>
                    <td class="text-end">
...
import PurchaseOrderProductModal from '../../modals/ProductModal.vue';
import PurchaseOrderProductList from '../product/ProductList.vue';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const formData = ref(props.existing_data);
    ...
    let issuerImage = formData.value.issuer_image ?? null;
    ...
    const updateModel = () => {
      ...
      formData.value.type = FormTypes.PURCHASE_ORDER;
    ...
    /**
     * Handle added product in purchase order product form modal
     *
     * @param {object} purchaseOrderProduct
     */
    const handleAddedProduct = (purchaseOrderProduct) => {
      products.value.push(purchaseOrderProduct);
    };
    ...
    /**
     * Handle delete product in purchase order product list
     *
    ...
    const getLogo = () => {
      if (
        ...
        return logo.value
          ? `/api/forms/purchase-orders/images/restore?code=${logo.value}`
    ...
    const clearLocalUploadFiles = () => {
      ...
      issuerImage = null;
      formData.value.issuer_image = null;
    ...
    const handleSubmitForm = async () => {
      ...
      purchaseOrderApiService
        .validateCreatePurchaseOrderForm(formData.value)
    ...
    const initializeFileuploader = () => {
      ...
      fileUploader.value = FileUploaderFacade({
        selector: '.js-form-purchase-order-file-uploader',
