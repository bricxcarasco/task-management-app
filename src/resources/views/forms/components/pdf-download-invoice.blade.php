...
<h1 class="heading">{{ __('Invoice') }}</h1>
<!-- First row -->
<table class="table table--sm">
  <tbody>
    <tr>
      <td width="55%">{{ $form->zipcode }}</td>
      <td rowspan="2" width="20%" class="pr-15 text-right">{{ __('Invoice No') }}：</td>
...
<table class="table table--sm">
  <tbody>
    ...
    <tr>
      <td class="pr-15 align-top text-right" width="55%">{{ __('We would like to request the following inquiries.') }}</td>
...
<div class="table-container">
  <table class="table table--sm mt-10">
    <tbody>
      ...
      <tr>
        <td width="15%" class="pl-10 text-center border-bottom">
          {{ __('Payment Date') }}<span class="float-right">：</span>
        </td>
        <td width="40%" class="pl-10 border-bottom">{{ $form->payment_date }}</td>
      ...
      <tr>
        <td width="15%" class="pl-10 text-center border-bottom">{{ __('Payment terms') }}<span class="float-right">：</span></td>
        <td width="40%" class="pl-10 border-bottom">{{ $form->payment_terms }}</td>
      </tr>
...
<table class="table mt-20">
  ...
  <tbody>
    ...
    <tr>
      <td colspan="2" class="no-border bold" style="letter-spacing: 10px; font-size: 1.6rem; padding-bottom: 0;">【{{ __('Remarks') }}】</td>
...
<table class="table bold mt-20">
  <tbody>
    <tr>
      <td colspan="2" class="no-border bold text-center" style="padding-right: 35px; letter-spacing: 10px; font-size: 1.6rem; padding-bottom: 0;">【{{ __('Payee Information') }}】</td>
...
<div class="notes-wrapper mt-20">
  <p class="notes paragraph-content" style="word-wrap:break-word;">
    {!! nl2br(e($form->issuer_payee_information)) ?? '' !!}
  </p>
</div>