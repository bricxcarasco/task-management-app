...
<h1 class="heading">{{ __('Quotation') }}</h1>
<!-- First row -->
<table class="table table--sm">
  <tbody>
    <tr>
      <td width="55%">{{ $form->zipcode }}</td>
      <td rowspan="2" width="20%" class="pr-15 text-right">{{ __('Quotation number') }}：</td>
...
<table class="table table--sm">
  <tbody>
    ...
    <tr>
      <td class="pr-15 align-top text-right" width="55%">{{ __('For inquiries, we will quote as follows.') }}</td>
...
<div class="table-container">
  <table class="table table--sm mt-10">
    <tbody>
      ...
      <tr>
        <td width="15%" class="pl-10 text-center border-bottom">{{ __('Estimated expiration date') }}<span class="float-right">：</span></td>
        <td width="40%" class="pl-10 border-bottom">{{ $form->expiration_date }}</td>
      </tr>
    </tbody>
  </table>
