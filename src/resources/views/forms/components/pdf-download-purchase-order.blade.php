...
<h1 class="heading">{{ __('Purchase order') }}</h1>
<!-- First row -->
<table class="table table--sm">
  <tbody>
    <tr>
      <td width="55%">{{ $form->zipcode }}</td>
      <td rowspan="2" width="20%" class="pr-15 text-right">{{ __('Purchase Order No') }}：</td>
...
<table class="table table--sm">
  <tbody>
    ...
    <tr>
      <td class="pr-15 align-top text-right" width="55%">{{ __('For inquiries, we will place an order as follows.') }}</td>
