...
<div class="preview">
    <h3 class="preview__header">{{ __('Delivery slip') }}</h3>
            ...
            <table class="preview__table table preview__table--no-border">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="text-left">{{ __('Delivery Number') }}：</td>
                    ...
                    <tr>
                        <td colspan="9" class="text-right">
                            {{ __('We will deliver the inquiry as follows.') }}
                        </td>
                    ...
                    <tr>
                        <td colspan="3" class="preview__table--bottom-line p-0 text-center">
                            <span class="text-justify nowrap">{{ __('Delivery deadline') }}</span>
                            <span class="float-right">：</span>
                        </td>
                        <td colspan="6" class="preview__table--bottom-line p-0 text-left">
            ...
            <table class="preview__table preview__table--border table">
                ...
                <tbody>
                    ...
                    @if (!empty($pricesAndTaxes))
                        ...
                        <tr>
                            <td class="border-none"></td>
                            <td colspan="1" class="preview__table-delivery border-none text-left p-0">
