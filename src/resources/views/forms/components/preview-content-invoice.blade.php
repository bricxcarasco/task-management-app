...
<div class="preview">
    <h3 class="preview__header">{{ __('Invoice2') }}</h3>
            ...
            <table class="preview__table table preview__table--no-border">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="text-left">{{ __('Invoice No') }}：</td>
                    ...
                    <tr>
                        <td colspan="9" class="text-right">
                            {{ __('We would like to request the following inquiries.') }}
                        </td>
                    ...
                    <tr>
                        <td colspan="3" class="preview__table--bottom-line p-0 text-center">
                            <span class="text-justify nowrap">{{ __('Payment Date') }}</span>
                            <span class="float-right">：</span>
                        </td>
                        <td colspan="6" class="preview__table--bottom-line p-0 text-left">
                            {{ $form->payment_date }}
            ...
            <table class="preview__table preview__table--border table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="border-none"></td>
                        <td colspan="1"
                            class="preview__table-remarks preview__table-payee border-none text-left p-0">
