...
class NeoInvitationNotification extends EmailNotification
{
    /**
     * @var \App\Models\Neo
     */
     ...
     * @var int
     */
    private $template = MailTemplates::NEO_INVITATION;
     ...
     */
    public function __construct($neo, $rio)
    {
        $this->neo = $neo;
        $this->rio = $rio;
    }
    ...
    public function toMail($user)
    {
        ...
        $subjectData = [
            'neo_name' => $this->neo->organization_name ?? '-',
        ];
        $contentData = [
            'neo_name' => $this->neo->organization_name ?? '-',
