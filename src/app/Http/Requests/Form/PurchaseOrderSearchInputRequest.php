...
class PurchaseOrderSearchInputRequest extends FormRequest
{
    /**
    ...
    protected function prepareForValidation()
    {
        $this->merge([
            ...
            'isDeliveryDate' => $this->delivery_start_date && $this->delivery_end_date ? true : false,
    ...
    public function rules()
    {
        ...
        if ($this->isDeliveryDate) {
            $rules['delivery_end_date'] = 'after_or_equal:delivery_start_date';
        }
