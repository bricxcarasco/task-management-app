...
class InvoiceSearchInputRequest extends FormRequest
{
    /**
    ...
    protected function prepareForValidation()
    {
        $this->merge([
            ...
            'isPaymentDate' => $this->payment_start_date && $this->payment_end_date ? true : false,
    ...
    public function rules()
    {
        ...
        if ($this->isPaymentDate) {
            $rules['payment_end_date'] = 'after_or_equal:payment_start_date';
        }
