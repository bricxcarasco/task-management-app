...
class DuplicateFileRename implements Rule
{
    /** @var object */
    private $request;
    ...
    public function passes($attribute, $value)
    {
        ...
        if ($document->document_type === DocumentTypes::FILE) {
    ...
    {
        return trans('messages.duplicate_file_name');
    }
}
