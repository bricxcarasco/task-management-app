!(function () {
  ...
  function d(d, $) {
    ...
    for (; d.length && (t = d.shift()); )
      d.length || void 0 === $
        ? (n = n[t] && n[t] !== Object.prototype[t] ? n[t] : (n[t] = {}))
        : (n[t] = $);
  }
  function $(d, r) {
    function $() {}
    ($.prototype = r.prototype),
      (d.$ = r.prototype),
      (d.prototype = new $()),
      ((d.prototype.constructor = d).fa = function (d, $, t) {
        for (
          var n = Array(arguments.length - 2), e = 2;
          e < arguments.length;
          e++
        )
          n[e - 2] = arguments[e];
  ...
  (h.prototype.has = function (d) {
          ...
          (function d($, t) {
            for (var n = s($.j()), e = 0; e < n.length; e++) {
              ...
              if (null != t.g[r]) {
                ...
                var i = 11 == u.i || 10 == u.i;
                if (u.m)
                  for (var u = S(t, r), o = 0; o < u.length; o++)
                    T($, r, i ? u[o].clone() : u[o]);
                else
                  (u = p(t, r)),
                    i
    ...
    (A.prototype.i = function (d, $) {
      if (11 == d.i || 10 == d.i)
        return $ instanceof h ? $ : this.g(d.v.prototype.j(), $);
      if (14 == d.i)
        return 'string' == typeof $ && E.test($) && 0 < (d = Number($)) ? d : $;
      if (!d.u) return $;
      if ((d = d.v) === String) {
        ...
        v ||
          (v = d =
            y(R, {
              ...
              1: { name: 'general_desc', h: 11, type: B },
              2: { name: 'fixed_line', h: 11, type: B },
              3: { name: 'mobile', h: 11, type: B },
              4: { name: 'toll_free', h: 11, type: B },
              5: { name: 'premium_rate', h: 11, type: B },
              6: { name: 'shared_cost', h: 11, type: B },
              7: { name: 'personal_number', h: 11, type: B },
              8: { name: 'voip', h: 11, type: B },
              21: { name: 'pager', h: 11, type: B },
              25: { name: 'uan', h: 11, type: B },
              27: { name: 'emergency', h: 11, type: B },
              28: { name: 'voicemail', h: 11, type: B },
              29: { name: 'short_code', h: 11, type: B },
              30: { name: 'standard_rate', h: 11, type: B },
              31: { name: 'carrier_specific', h: 11, type: B },
              33: { name: 'sms_services', h: 11, type: B },
              24: { name: 'no_international_dialling', h: 11, type: B },
              ...
              19: { name: 'number_format', o: !0, h: 11, type: _ },
              20: { name: 'intl_number_format', o: !0, h: 11, type: _ },
              22: {
  ...
  function n1(d, $) {
    for (var t, n = new G(), e = d.length, r = 0; r < e; ++r)
  ...
  function r1(d, $, t) {
    ...
    d: {
      for (
        var r = (d = 0 == S(d, 20).length || 2 == t ? S(d, 19) : S(d, 20))
            .length,
          i = 0;
        i < r;
        ++i
        ...
        var u,
          o = m((u = d[i]), 3);
        if (
          (0 == o || 0 == e.search(c(u, 3, o - 1))) &&
          T1((o = new RegExp(c(u, 1))), e)
        ) {
          d = u;
          break d;
        }
  ...
  function u1(d) {
    ...
    var $ = '' + c(d, 2);
    return null != d.g[4] && c(d, 4) && 0 < C(d, 8)
      ? Array(C(d, 8) + 1).join('0') + $
      : $;
  }
  function o1(d, $, t, n) {
    switch ($) {
  ...
  function p1(d, $, t, n) {
    ...
    if (2 == n) {
      ...
      t1((d = l1(t, 1))) &&
        ((e = e.concat(0 == m(d, 9) ? S(c(t, 1), 9) : S(d, 9))).sort(),
        0 == r.length ? (r = S(d, 10)) : (r = r.concat(S(d, 10))).sort());
    }
    return -1 == e[0]
      ? 5
      : (($ = $.length),
    ...
    if (
      ...
      return null != t &&
        ...
        0 == (i = $.toString()).lastIndexOf(o, 0) &&
          ((o = new G(i.substring(o.length))),
          (i = c(t, 1)),
          (i = new RegExp(C(i, 2))),
          S1(o, t, null),
          (o = o.toString()),
          (!T1(i, $.toString()) && T1(i, o)) ||
            3 == p1(d, $.toString(), t, -1)))
        ? (n.g(o), e && M(r, 6, 10), M(r, 1, u), u)
        : (M(r, 1, 0), 0);
  ...
  function S1(d, $, t) {
    ...
    0 == u ||
      null == o ||
      0 == o.length ||
      ((u = (n = new RegExp('^(?:' + o + ')')).exec(i)) &&
        ((e = T1((o = new RegExp(C(c($, 1), 2))), i)),
        (r = u.length - 1),
        null == ($ = c($, 16)) ||
        0 == $.length ||
        null == u[r] ||
        0 == u[r].length
          ? (e && !T1(o, i.substring(u[0].length))) ||
            (null != t && 0 < r && null != u[r] && t.g(u[1]),
            d.set(i.substring(u[0].length)))
          : ((i = i.replace(n, $)),
            (e && !T1(o, i)) || (null != t && 0 < r && t.g(u[1]), d.set(i)))));
  }
  function m1(d, $, t) {
    if (!e1(t) && 0 < $.length && '+' != $.charAt(0))
      throw Error('Invalid country calling code');
    return M1(d, $, t, !0);
  }
  function M1($, t, d, n) {
      ...
      (0 <= i
        ? ('+' == t.charAt((e = i + 15)) &&
            (0 < (u = t.indexOf(';', e))
              ...
              : r.g(t.substring(e))),
          (e = t.indexOf('tel:')),
          r.g(t.substring(0 <= e ? e + 4 : 0, i)))
        : ((i = r.g),
          0 <= (e = t.search(w))
            ? 0 <= (u = (e = (e = t.substring(e)).replace(Y, '')).search(W)) &&
              (e = e.substring(0, u))
            : (e = ''),
          i.call(r, e)),
      0 < (e = (i = r.toString()).indexOf(';isub=')) &&
        ((r.i = ''), r.g(i.substring(0, e))),
      !q(r.toString()))
    )
      throw Error('The string supplied did not seem to be a phone number');
    if (
      ((i = r.toString()), !(e1(d) || (null != i && 0 < i.length && H.test(i))))
    )
      throw Error('Invalid country calling code');
    (i = new O()), n && M(i, 5, t);
    d: {
    ...
    if (
      (0 != u
        ...
        : ($1(r),
          ...
          null != d
            ? M(i, 1, (u = C(e, 10)))
            : n && (delete i.g[6], i.i && delete i.i[6])),
      t.i.length < 2)
    )
    ...
    if (
      (null != e &&
        ((d = new G()),
        S1((r = new G(t.toString())), e, d),
        2 != ($ = p1($, r.toString(), e, -1)) &&
          4 != $ &&
          5 != $ &&
          ((t = r), n && 0 < d.toString().length && M(i, 7, d.toString()))),
      ($ = (n = t.toString()).length) < 2)
    )
      throw Error('The string supplied is too short to be a phone number');
    if (17 < $)
      throw Error('The string supplied is too long to be a phone number');
  ...
  d('intlTelInputUtils', {}),
    d('intlTelInputUtils.formatNumber', function ($, d, t) {
      try {
        var n = F.g(),
          e = m1(n, $, d),
          r = c1(n, e);
      ...
      try {
        ...
        return 'Invalid country calling code' == d.message
          ...
          : 'Phone number too short after IDD' == d.message ||
            'The string supplied is too short to be a phone number' == d.message
          ? 2
