...
class CreateNeoGroupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('neo_groups', function (Blueprint $table) {
            $table->id()->comment('id for Laravel');
            $table->unsignedBigInteger('neo_id')->comment('0:申請中 、1:つながり状態');
    ...
    {
        Schema::dropIfExists('neo_groups');
    }
}
