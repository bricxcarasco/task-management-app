...
class CreateTableRioConnectionUsers extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rio_connection_users', function (Blueprint $table) {
            $table->id()->comment('id for Laravel');
            $table->unsignedBigInteger('rio_connection_id');
            ...
            $table->foreign('rio_connection_id')->references('id')->on('rio_connections');
    ...
    {
        Schema::dropIfExists('rio_connection_users');
    }
}
