...
class CreateNeoPaymentPasswordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('neo_payment_passwords', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('neo_payment_passwords');
    }
}
