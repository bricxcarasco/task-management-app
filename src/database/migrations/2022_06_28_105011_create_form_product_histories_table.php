...
class CreateFormProductHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_product_histories', function (Blueprint $table) {
            $table
                ->id()
                ->comment('id for Laravel');
            $table
                ->unsignedBigInteger('form_history_id');
            $table
    ...
    {
        Schema::dropIfExists('form_product_histories');
    }
}
