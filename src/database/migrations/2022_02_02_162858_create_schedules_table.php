...
class CreateSchedulesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('schedules', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('owner_rio_id')->nullable()->comment('↓どちらかのみセット');
            $table->unsignedBigInteger('owner_neo_id')->nullable()->comment('↑どちらかのみセット');
            $table->unsignedBigInteger('created_rio_id');
